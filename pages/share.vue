        ...
        <div class="col-start-4 rounded-md col-span-6 tablet:col-start-2 tablet:col-span-10 desktop:col-start-5 desktop:col-span-4 bg-white px-12 max-w-682">
          ...
          <div class="h-48">
            ...
            <div v-else class="h-48 w-full flex justify-center items-center">
              <div v-if="uploadStep===0" class="text-2xl cursor-pointer" @click="uploadFile">
              ...
              <div v-else-if="uploadStep===1">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; display: block; shape-rendering: auto;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                  <path fill="none" stroke="#7961bd" stroke-width="6" stroke-dasharray="64.14723205566406 64.14723205566406" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z" stroke-linecap="round" style="transform:scale(0.5);transform-origin:50px 50px">
...
export default {
  ...
  data () {
    return {
      uploadStep: 0, // 0未上传，1上传中，2上传完成，3提交完成
