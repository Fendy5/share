<template>
  <section class="bg-indigo-600 h-screen">
    <div class="mx-auto flex justify-center lg:items-center h-full">
      <form id="login" class="w-full sm:w-4/6 md:w-3/6 lg:w-4/12 xl:w-3/12 text-white py-12 px-2 sm:px-0" @submit.prevent>
        ...
        <div class="mt-12 w-full px-2 sm:px-6">
          <div class="flex flex-col mt-5">
            ...
            <input id="email" required name="email" class="h-10 px-2 w-full text-white bg-indigo-700 rounded mt-2 focus:outline-none shadow" type="email">
          </div>
          <div class="flex flex-col mt-5">
            <label for="password" class="text-lg font-semibold fleading-tight">Password</label>
            <input id="password" required name="password" class="h-10 px-2 w-full text-white bg-indigo-700 rounded mt-2 focus:outline-none shadow" type="password">
          </div>
        </div>
